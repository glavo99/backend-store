...
var OrderModel = /** @class */ (function () {
    ...
    OrderModel.prototype.createProduct = function (quantity, orderId, productId) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    OrderModel.prototype.create = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, newOrder, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'SELECT status, email, firstname, lastname FROM users INNER JOIN orders ON users.id = orders.user_id WHERE orders.id=($1);';
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not find user with id ".concat(id, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Could not find product with id ".concat(id, ". Error: ").concat(err_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrderModel.prototype.showCart = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'SELECT quantity, name, price, status, user_id FROM order_products INNER JOIN products ON products.id = order_products.product_id INNER JOIN orders ON orders.id = order_products.order_id WHERE order_products.id =($1);';
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [id])];
                    ...
                    case 3:
                        err_6 = _a.sent();
                        throw new Error("Could not find user with id ".concat(id, ". Error: ").concat(err_6));
                    case 4: return [2 /*return*/];
                }
            });
        });
