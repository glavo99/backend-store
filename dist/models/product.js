...
var ProductModel = /** @class */ (function () {
    ...
    ProductModel.prototype.create = function (product) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, newProduct, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not find product with id ".concat(id, ". Error: ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not find product with id ".concat(id, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    ProductModel.prototype.update = function (price, id) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, newProduct, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Could not add new Product. Error: ".concat(err_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
